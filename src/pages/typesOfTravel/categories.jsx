        ...
        <div className="categoriesBackground my-5">
            ...
            <div className="container text-center w-75">
                <div className="row row-cols-2 row-cols-lg-5 g-2 g-lg-3">
                    <div className="col">
                        <img src="./images/typesoftravel/temple1.jpg" className="img-thumbnail categoriesCardImg effect" alt="..." /></div>
                    <div className="col">
                        <img src="./images/typesoftravel/temple2.jpg" className="img-thumbnail categoriesCardImg effect" alt="..." /></div>
                    <div className="col">
                        <img src="./images/typesoftravel/temple3.jpg" className="img-thumbnail categoriesCardImg effect" alt="..." /></div>
                    <div className="col">
                        <img src="./images/typesoftravel/temple4.jpg" className="img-thumbnail categoriesCardImg effect" alt="..." /></div>
                    <div className="col">
                        <img src="./images/typesoftravel/temple5.jpg" className="img-thumbnail categoriesCardImg effect" alt="..." /></div>
                </div>
            </div>
